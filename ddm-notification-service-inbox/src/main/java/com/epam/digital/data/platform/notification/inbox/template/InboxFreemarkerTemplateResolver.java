...
package com.epam.digital.data.platform.notification.inbox.template;
...
public class InboxFreemarkerTemplateResolver implements TemplateResolver<String, String> {
