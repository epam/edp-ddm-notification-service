...
class InboxNotificationTemplateServiceTest {

  @Mock
  private InboxNotificationTemplateRepository repository;

  private InboxNotificationTemplateService service;

  @BeforeEach
  void setUp() {
    service = new InboxNotificationTemplateService(repository);
  }
