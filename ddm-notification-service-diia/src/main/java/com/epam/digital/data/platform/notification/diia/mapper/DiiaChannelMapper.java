...
package com.epam.digital.data.platform.notification.diia.mapper;
...
@Component
public class DiiaChannelMapper implements ChannelMapper {

  @Override
  public ChannelObject map(ChannelReadDto channelReadDto) {
    return ChannelObject.builder()
        .rnokpp(channelReadDto.getAddress())
